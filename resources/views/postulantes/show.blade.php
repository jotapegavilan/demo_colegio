<x-app-layout>
    <div class="container py-8">
        <span class="text-4xl font-bold text-gray-600">
            {{$postulante->names}} {{$postulante->surnames}}
        </span>
        <span>
        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-2">
                <img class="object-scale-down w-100 h-60 rounded-2xl" src="{{Storage::url($postulante->image->url)}}" alt="">
        <span class="text-lg text-gray-600">
            Postula al {{$postulante->curso->number}}-{{strtoupper($postulante->curso->letter)}}.
        </span>       
        <br> 
        <span class="text-lg text-gray-600">
